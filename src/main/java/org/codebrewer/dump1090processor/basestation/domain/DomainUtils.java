...
/**
 * Utility methods related to the dump1090 application's BaseStation support.
 */
public class DomainUtils {
   ...
   * BaseStation messages generated by the {@code dump1090} application.
   *
   * <p>{@code dump1090} does not generate all message types defined by BaseStation.
   *
   ...
   * of BaseStation messages generated by the {@code dump1090} application.
   *
   * <p>{@code dump1090} does not generate all status message types defined by BaseStation.
   *
